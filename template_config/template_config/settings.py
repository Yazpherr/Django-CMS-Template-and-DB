"""
Django settings for template_config project.
...
SECRET_KEY = "django-insecure-@f_qbkekh79t0ewktk#&3=$p(oj4kh%staf8a*ejq$$7)$_!b="
...
ROOT_URLCONF = "template_config.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            os.path.join(BASE_DIR, "template_config", "templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "template_config.wsgi.application"
...
STATICFILES_DIRS = [
    BASE_DIR / "template_config" / "static",
]
